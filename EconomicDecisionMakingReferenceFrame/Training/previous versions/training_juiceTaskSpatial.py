...
taskTrainName = 'juiceTaskSpatialTarget'
...
dd = DelayedEconomicDecision_AlternateOutput(dt = dt, tau = tau, T = T, N_trials_per_condition = N_trials_per_condition,target_delay_duration=500,wait_duration=500,outputMode='juice',encode_spatial=True,spatial_timing='target')
