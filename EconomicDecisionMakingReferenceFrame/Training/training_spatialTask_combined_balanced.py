from delayed_economic_decision_balanced import (
    ...
    DelayedEconomicDecision_BalancedCombined,
)
...
taskTrainName = 'spatialTaskCombinedBalanced'
...
dd = DelayedEconomicDecision_BalancedCombined(
    dt=dt, tau=tau, T=T,
...
dd_test = DelayedEconomicDecision_SpatialTask(
    dt=dt, tau=tau, T=T,
    target_delay_duration=500, wait_duration=500,
